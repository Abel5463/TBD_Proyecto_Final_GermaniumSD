    ...
    <div class="container">
        <nav class="navbar navbar-expand-lg navbar-light">
            <div class="container-fluid">
                <a class="navbar-brand" href="index2.php">GermaniumSD</a>
            ...
            <div class="row">
                ...
                <div class="col-md-5 ms-auto">
                    ...
                    <div class="d-grid gap-2">
                        ...
                        <button class="btn btn-warning" type="button" id="btnVaciar"><a href='index2.php' id="link"> Comprar Ahora</a></button>
                    </div>
                </div>
            </div>
        </div>
