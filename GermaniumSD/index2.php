...
<body>
    ...
    <a href="#" class="btn-flotante" id="btnCarrito2">Carrito <span class="badge bg-success" id="carrito">0</span></a>
    <!-- Navigation-->
    <div class="container">
        <nav class="navbar navbar-expand-lg navbar-light">
            <div class="container-fluid">
                <a class="navbar-brand" href="#">GermaniumSD</a>
                ...
                <div class="collapse navbar-collapse" id="navbarNav">
                    <ul class="navbar-nav">
                        ...
                        <!--Se trae las categorias de la base de datos para la barra de navegación-->
                        <?php
                        $server = "localhost";
                        $database = "card";
                        $username = "root";
                        ...
                        $consulta = $pdo->query("SELECT * FROM categorias");
                ...
                <a href="Admin/index.php">Cerrar sesión</a>
    ...
    <section class="py-5">
        <div class="container px-4 px-lg-5">
            <div class="row gx-4 gx-lg-5 row-cols-2 row-cols-md-3 row-cols-xl-4 justify-content-center">
                <?php
                $consulta = $pdo->query("SELECT p.*, c.id AS id_cat, c.categoria FROM productos p INNER JOIN categorias c ON c.id = p.id_categoria");
    ...
    <footer class="py-5 bg-dark">
        <div class="container">
            <p class="m-0 text-center text-white">Copyright &copy; GermaniumSD 2023</p>
        </div>
    </footer>
    <!-- Bootstrap core JS-->
